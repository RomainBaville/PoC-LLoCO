...
problem_84_prompt: str = (
    ...
    "The team has a limited budget of $35,000. They need to ensure that the total payment to the selected candidates "
    ...
    "Due to the equivalent professional skills of candidates A and E, at most one from the two will be choose.\n\n"
...
score_config: ScoreConfig = ScoreConfig( use_ressources=True, ressources_config=ressources_config )
...
quantities_constraints: QuantitiesConstraints = QuantitiesConstraints(
    max_left_entities=max_left_entities, min_left_entities=min_left_entities
)
