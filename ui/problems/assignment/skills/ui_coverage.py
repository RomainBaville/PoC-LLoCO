...
def render(step: int):
    ...
    # Defensive defaults
    # --------------------------------------------------
    st.session_state.setdefault("left_label", "Left entities")
    st.session_state.setdefault("right_label", "Right entities")
    ...
    if step == 4:
        ...
        log_step(
            f"Defined '{st.session_state.left_label}' assigned to "
            f"'{st.session_state.right_label}' based on skills."
        )
