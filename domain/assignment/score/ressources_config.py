...
class RessourcesConfig:
    ...
    This score optimization use a score computation from an addition of the left entities ressources.
    ...
    Args:
        ...
        vals (dict[tuple[str, str], float]): The dictionary with the value of the left entities
            for all the ressources used in the score computation:
        ...
        objectives (dict[str, Objective]): The dictionary with ressources objectives used in the score computation:
            ...
            - values (Objective): The objective with the ressources.
        ...
        max_vals (Optional[dict[tuple[str, ...], float]]): The dictionary whit the maximum ressources values
            accepted per right entities:
        ...
        min_vals (Optional[dict[tuple[str, ...], float]]): The dictionary whit the minimum ressources values
            accepted per right entities:
            - keys (tuple[str, ...]): The right entity label, the ressources labels constrainted.
            - value (float): The minimum value accepted for the ressources listed for the right entity.
        max_global_vals (Optional[dict[tuple[str, ...], float]]): The dictionary whit the maximum ressources
            values accepted for all the right entities:
        ...
        min_global_vals (Optional[dict[tuple[str, ...], float]]): The dictionary whit the minimum ressources
            values accepted for all the right entities:
            - keys (tuple[str, ...]): The ressources labels constrainted at once.
