...
class QuantitiesConstraints:
        ...
        Args:
            max_right_entities (Optional[dict[str, float]]): The dictionary with the maximum number of different right entities, a left entity can be assigned to:
                - keys (str): The left entity label.
                - values (float): The maximum number of different right entities allowed.
            min_right_entities (Optional[dict[str, float]]): The dictionary with the minimum number of different right entities, a left entity can be assigned to:
                - keys (str): The left entity label.
                - values (float): The minimum number of different right entities allowed.
            max_left_entities (Optional[dict[str, float]]): The dictionary with the maximum number of different left entities, a right entity can handled:
                - keys (str): The right entity label.
                - values (float): The maximum number of different left entities allowed.
            min_left_entities (Optional[dict[str, float]]): The dictionary with the minimum number of different left entities, a right entity can handled:
                - keys (str): The right entity label.
            ...
            multiple_same_assignment (bool): True if a left entity can be assigned more than once to the same right entity.
                Defaults to False.
            max_same_assignments (Optional[dict[tuple[str, str], float]]): The dictionary whit the maximum number of assignments allowed by left entities per right entities:
        ...
        """
        max_right_entities: Optional[ dict[ str, float ] ] = None
        min_right_entities: Optional[ dict[ str, float ] ] = None

        max_left_entities: Optional[ dict[ str, float ] ] = None
        min_left_entities: Optional[ dict[ str, float ] ] = None
